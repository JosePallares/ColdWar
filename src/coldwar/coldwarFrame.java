...
public class coldwarFrame extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ReglasFrame reglasframe = new ReglasFrame();
        reglasframe.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        InformacionFrame informacionframe = new InformacionFrame();
...
class FondoPanel extends JPanel
{
    ...
    {
        imagen = new ImageIcon(getClass().getResource("/Imagen/coldwar2.jpg")).getImage();
